    ...
    return (
        <>
            ...
            <div className='min-h-screen bg-[#FDFDFC] text-[rgb(255, 245, 235)] dark:bg-background'>
                ...
                <section className='relative mx-auto w-full max-w-7xl px-4 pb-12 pt-6 mb-8'>
                    ...
                    <div className='relative z-10 text-white'>
                        ...
                        <p className='mt-4 max-w-2xl text-white/80'>
                            Create, survive, and automate—from vanilla survival to massive modpacks, minigames, and
                            redstone engineering. Get your server running in minutes with reliable hosting and
                ...
                <section
                    id='specs'
                    className='relative mx-auto grid w-full max-w-7xl grid-cols-1 gap-6 px-4 pb-24 md:grid-cols-2'
                >
                    <div className='p-6'>
                        <h2 className='text-6xl font-semibold text-white'>
                            Unmatched Speed,
                            <br /> <span className='text-[#5eb14a]'>Incredible Value.</span>
                        </h2>
                        <p className='mt-4 text-white/80 text-lg'>
                            Our AMD Ryzen 5950X powered servers crush the competition, delivering next‑gen performance
                            at just 30Kč per gigabyte. Enjoy instant spin‑ups, rock‑solid uptime, and low‑latency
                            connections for a seamless gaming experience.
                        </p>
                    ...
                    <div className='p-6'>
                        ...
                        <div className='space-y-[-10px]'>
                            ...
                            <PerformanceBar
                                ...
                                color='bg-[#F6E05E]'
                                value={0.55}
                                icon={<BrandSquare>L</BrandSquare>}
                            />
                            <PerformanceBar
                ...
                <section className='relative mx-auto w-full pb-24'>
                    <h2 className='mb-4 text-2xl font-semibold text-white text-center'>Loved by gamers worldwide</h2>
                    <p className='mb-4 text-white/80 text-center'>
                        Join thousands of satisfied customers who trust our game server hosting needs. See what our
                ...
                <section className='relative mx-auto w-full max-w-7xl px-4 pb-16'>
                    <div className='mb-6 flex flex-col items-center gap-4 md:flex-row md:justify-between'>
                        <h2 className='text-2xl font-semibold text-white'>Simple, transparent pricing.</h2>
                ...
                <section className='relative mx-auto w-full max-w-7xl px-4 pb-20'>
                    <h2 className='mb-6 text-2xl font-semibold text-white'>Minecraft Server Hosting FAQ</h2>
                ...
                <footer className='mx-auto w-full max-w-7xl px-4 pb-10 text-xs text-white/50'>
                    Prices and specs are indicative. Final performance varies by node and workload. Features may change
                    without notice.
                </footer>
            </div>
        </>
                ...
                <div className='flex items-center justify-start sm:justify-end w-full'>
                    <span className='inline-flex flex-col gap-1 px-3 py-1 text-md font-bold w-70'>
                        ...
                        <div className='h-[8px] w-full rounded-full bg-white/12'>
                            <div className={`h-[8px] rounded-full ${color}`} style={{ width: '100%' }} />
                        </div>
                    </span>
                </div>
...
function BrandSquare({ children }: { children: React.ReactNode }) {
    return <div className='flex h-5 w-5 items-center justify-center rounded bg-white/12 text-[10px]'>{children}</div>;
}
    ...
    return (
        <div className='space-y-4'>
            ...
            <div className='mt-2 flex items-center justify-center gap-2 text-sm text-white/70'>
                ...
                <a href='#' className='text-green-300 underline-offset-4 hover:underline'>
                    Discord community
                </a>
            </div>
        </div>
...
function MarqueeRow({ direction, items }: { direction: 'left' | 'right'; items: Review[] }) {
...
function BillingToggle({ bill, onChange }: { bill: Bill; onChange: (b: Bill) => void }) {
    return (
        <div className='inline-flex items-center gap-1 rounded-full border border-white/10 bg-white/5 p-1'>
            <button
                onClick={() => onChange('monthly')}
                className={`rounded-full px-3 py-1 text-sm text-white ${
                    bill === 'monthly' ? 'bg-green-600' : 'hover:bg-white/10'
                }`}
            >
                Monthly
            </button>
            <button
                ...
                className={`rounded-full px-3 py-1 text-sm text-white ${
                    bill === 'yearly' ? 'bg-green-600' : 'hover:bg-white/10'
                }`}
            >
                Yearly
            </button>
    ...
    return (
        ...
        >
            ...
            <div className='mb-1 text-3xl font-bold'>
                Kč{price}
                <span className='ml-1 align-middle text-sm font-normal text-white/80'>/month</span>
            </div>
            ...
            <Button className='w-full text-white h-10 '>Configure Server</Button>
        </div>
    );
}
    ...
    return (
        <div className='rounded-2xl border border-black/15 bg-[#110F0D] p-4 text-white shadow-[0_8px_24px_rgba(0,0,0,0.25)] dark:border-white/10'>
            <div className='mb-3 inline-flex items-center gap-2'>
                <span className='rounded-full bg-green-700 px-2 py-0.5 text-xs font-semibold'>Custom</span>
            </div>
            ...
            <div className='grid grid-cols-1 items-start gap-4 md:grid-cols-12'>
                ...
                <div className='md:col-span-3 space-y-2 text-sm'>
                    ...
                    <FeatureRow
                        icon={<IconStorage className='h-5 w-5 text-green-400' />}
                ...
                <div className='md:col-span-2 flex items-center justify-end'>
                    <Button className='w-full text-white'>Configure Server</Button>
                </div>
            </div>
            ...
            <div className='mt-4 grid grid-cols-1 gap-4 md:grid-cols-12'>
                <div className='md:col-span-6'>
                    ...
                    <Slider value={[ram]} min={3} max={32} step={1} onValueChange={(v) => setRam(v[0] ?? ram)} />
                ...
                <div className='md:col-span-12'>
                    <div className='mt-3 rounded-lg border border-green-800 bg-green-900/40 px-4 py-3 text-sm text-green-200'>
                        ...
                        <div className='text-xs text-green-300/80'>You can always adjust the RAM later if needed.</div>
                    </div>
                </div>
            </div>
        </div>
